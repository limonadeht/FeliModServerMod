...
public class BlockLimoneFluid extends BlockFluidClassic{
	...
	public BlockLimoneFluid(Fluid fluid, Material material) {
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		this.baseIcon = par1IconRegister.registerIcon("felimodserver:fluid/limone_flow");
		this.sideIcon = par1IconRegister.registerIcon("felimodserver:fluid/limone_still");
