...
public class CatchRecipeHandler extends TemplateRecipeHandler{
	...
	private HashMap<ItemStack, ItemStack> recipeLoader() {
		if (neiNewRecipeRegister.newRecipeList != null && !neiNewRecipeRegister.newRecipeList.isEmpty()) {
			this.newRecipe = neiNewRecipeRegister.newRecipeList;
		}
